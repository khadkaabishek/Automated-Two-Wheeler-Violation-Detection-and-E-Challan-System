...
<div className="border-[#1E2530] border-t-0 border-r-0 border-b-1 border-l-0 border-solid flex px-8 py-4 justify-between items-center">
              <nav className="text-[#5A6070] text-[13px] flex items-center gap-1.5">
              ...
              <div className="flex items-center gap-2">
                <button className="rounded-[10px] text-gray-400 text-sm leading-5 border-[#2A3040] border-1 border-solid flex px-3 py-2 items-center gap-1.5">
            ...
            <div className="flex p-8 flex-1 gap-6">
              <div className="shrink-0 flex flex-col gap-4 w-160">
                <div className="rounded-[14px] bg-[#14171C] border-[#1E2530] border-1 border-solid flex p-4 flex-col gap-4">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                      <Cctv className="size-4 text-[#5A6070]" />
                      <span className="font-medium text-[#C8CDD6] text-sm leading-5">
                        Evidence Frame
                      </span>
                      <span className="rounded-md bg-[#1E2530] text-gray-400 text-[11px] px-2 py-0.5">
                        CAM-07
                      </span>
                    </div>
                    <span className="text-[#5A6070] text-xs">14:28:33 IST</span>
                  </div>
                  <div className="relative aspect-[16/9] rounded-[10px] border-[#1E2530] border-1 border-solid w-full overflow-hidden">
                    <img
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div className="relative aspect-video rounded-[10px] border-[#1E2530] border-1 border-solid overflow-hidden">
                      <img
                  ...
                  <button className="rounded-[10px] text-gray-400 text-sm leading-5 border-[#2A3040] border-1 border-solid flex py-2.5 justify-center items-center gap-2">
                    <PlayCircle className="size-4" />
                    View Full Video Clip
                  </button>
                </div>
              </div>
              <div className="shrink-0 rounded-[14px] bg-[#14171C] border-[#1E2530] border-1 border-solid flex p-6 flex-col gap-6 w-110">
                <div className="flex justify-between items-center">
                  <span className="font-semibold uppercase text-gray-400 text-sm leading-5 tracking-wide">
                    Violation Details
                  </span>
                  <span className="font-medium rounded-full bg-[#2A2010] text-[#C8A050] text-xs px-3 py-1">
                    Pending Review
                  </span>
                </div>
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-1">
                    <span className="uppercase text-[#4A5568] text-[11px] tracking-wide">
                      Violation ID
                    </span>
                    <span className="text-[#C8CDD6] text-sm leading-5">
                      VID-2025-04471
                    </span>
                  </div>
                  <div className="bg-[#1E2530] h-px" />
                  <div className="flex flex-col gap-1">
                    <span className="uppercase text-[#4A5568] text-[11px] tracking-wide">
                      Timestamp
                    </span>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="font-mono text-[#C8CDD6] text-sm leading-5 tracking-wider">
                      MH12AB3456
                    </span>
                  </div>
                  <div className="bg-[#1E2530] h-px" />
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="rounded-full bg-[#1E2530] w-full h-1.5 overflow-hidden">
                      <div className="w-[96%] rounded-full bg-[#2A6B7C] h-full" />
                    </div>
                  </div>
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="rounded-full bg-[#2A1515] text-[#C87070] text-xs flex px-3 py-1 items-center gap-1">
                      <HardHat className="size-3.5" />
                      No Helmet
                    </span>
                    <span className="rounded-full bg-[#2A2010] text-[#C8A050] text-xs flex px-3 py-1 items-center gap-1">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="resize-none rounded-[10px] bg-[#0F1115] text-[#C8CDD6] text-sm leading-5 border-[#2A3040] border-1 border-solid p-3 w-full h-24"
                  />
                </div>
                <div className="flex mt-auto flex-col gap-3">
                  <button className="font-medium rounded-xl bg-[#2A6B7C] text-[#E8ECEF] text-sm leading-5 flex justify-center items-center gap-2 w-full h-11">
                    <CheckCircle2 className="size-4" />
                    {`Approve & Issue Challan`}
                  </button>
                  <button className="rounded-xl text-[#8A5050] text-sm leading-5 border-[#3A2020] border-1 border-solid flex py-2.5 justify-center items-center gap-2 w-full">
